...
paths:
  /v1/ecm/templates/{templateId}:
    delete:
      ...
      deprecated: false
      description: >-
        Removes an existing template from the system. This operation is
        reversible, and the template can be restored if needed. Once removed,
        the template will no longer be available for creating new documents or
        envelopes unless restored.
      tags:
        - Template
        - Template
      parameters:
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/755605/apis/api-12252696-run
components:
  schemas:
