...
paths:
  /v1/ecm/envelopes/{envelopeId}:
    delete:
      ...
      deprecated: false
      description: >-
        Removes an existing envelope using its unique identifier. Be aware that
        this operation is reversible. The envelope will be temporarily placed in
        the trash, and can be restored if needed. If the envelope contains
        approved documents or signers, these will not be affected by the
        removal. Ensure the provided envelope ID exists and is valid before
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/755605/apis/api-12252678-run
components:
  schemas:
