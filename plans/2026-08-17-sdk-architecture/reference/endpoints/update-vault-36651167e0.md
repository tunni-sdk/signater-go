...
paths:
  /v1/ecm/vaults/{vaultId}:
    put:
      ...
      deprecated: false
      description: >-
        Replaces the full state of an existing vault. The access type may now be
        changed between UserAccount, Account and UserAccountGroup. When the
        resulting type is UserAccountGroup, MemberIds must contain at least one
        member (you must explicitly add yourself if you want to be a member).
      tags:
        - Vault
        - Vault
      parameters:
        ...
        content:
          application/json:
            ...
            example:
              ...
              memberIds:
                - f9494794-ae81-4014-b454-b30fa5d3eada
                - 9352bfb5-186b-438d-a575-8043f3c3e9e6
      responses:
        '204':
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/755605/apis/api-36651167-run
components:
  schemas:
