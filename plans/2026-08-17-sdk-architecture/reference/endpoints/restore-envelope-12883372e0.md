...
info:
  ...
  version: 1.0.0
paths:
  /v1/ecm/envelopes/{envelopeId}/restore/to/{vaultId}:
    post:
      summary: Restore envelope
      deprecated: false
      description: >-
        Restores a previously remover envelope using its unique identifier.
        Restoring an envelope does not alter any characteristics such as its
        status, documents, or signers.
      tags:
        - Envelope
        - Envelope
      parameters:
      ...
      responses:
        '204':
          description: Envelope restored successfully
          headers: {}
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/755605/apis/api-12883372-run
components:
  schemas:
