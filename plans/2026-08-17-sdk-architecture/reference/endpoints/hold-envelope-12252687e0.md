...
info:
  ...
  version: 1.0.0
paths:
  /v1/ecm/envelopes/{envelopeId}/hold:
    post:
      summary: Hold envelope
      deprecated: false
      description: >-
        Holds an existing envelope using its unique identifier, changing its
        status to 'hold'. Once holded, all signers will be prevented from
        approving or rejecting the envelope. This action effectively pauses the
        envelope's approval process, and it can be published at a later time if
        needed.
      tags:
        - Envelope
        - Envelope
      ...
      responses:
        '204':
          description: Envelope held successfully
          headers: {}
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/755605/apis/api-12252687-run
components:
  schemas:
