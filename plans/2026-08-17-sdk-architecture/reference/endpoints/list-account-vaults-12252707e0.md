...
info:
  ...
  version: 1.0.0
paths:
  /v1/ecm/vaults/accounts:
    get:
      summary: List account vaults
      deprecated: false
      description: >-
        Retrieves a list of all vaults associated with the account. This
        includes vaults that are accessible to the account's users, regardless
        of their access level, and allows for easy management and organization
        of resources like templates and envelopes.
      tags:
        - Vault
        - Vault
      parameters:
      ...
      responses:
        '200':
          description: Account vaults listed successfully
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/ListAccountVaultsApiResponse'
              example:
                items:
                  - id: f39a90a4-cc59-4097-9764-d549ea93648e
                    ...
                    updatedAtUtc: '2026-08-17T00:52:53.9840364Z'
                    ...
                    canBeRemoved: true
                    userAccountMembers:
                      - id: 715c4a9d-cdf4-45e8-8428-32413d9a7c9e
                        name: John Doe
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/755605/apis/api-12252707-run
components:
  schemas:
    ListAccountVaultsApiResponse:
      type: object
      properties:
        items:
          type: array
          items:
            $ref: '#/components/schemas/ListAccountVaultsApiResponseItem'
    ...
    Pagination:
      ...
      x-apidog-ignore-properties: []
      x-apidog-folder: ''
    ListAccountVaultsApiResponseItem:
      type: object
      properties:
        id:
          type: string
        ...
        userAccountMembers:
          ...
          items:
            $ref: >-
              #/components/schemas/ListAccountVaultsApiResponseItemUserAccountMember
      ...
      x-apidog-ignore-properties: []
      x-apidog-folder: ''
    ListAccountVaultsApiResponseItemUserAccountMember:
      type: object
      properties:
        id:
          type: string
