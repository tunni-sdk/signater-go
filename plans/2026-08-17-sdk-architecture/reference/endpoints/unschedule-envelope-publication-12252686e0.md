...
info:
  ...
  version: 1.0.0
paths:
  /v1/ecm/envelopes/{envelopeId}/unschedule:
    post:
      summary: Unschedule envelope publication
      deprecated: false
      description: >-
        Unschedules an existing envelope publication using its unique
        identifier, changing its status to 'hold'. Allowing it can be
        rescheduled or directly published at a later time if needed.
      tags:
        - Envelope
        - Envelope
      parameters:
      ...
      responses:
        '204':
          description: Envelope unscheduled successfully
          headers: {}
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/755605/apis/api-12252686-run
components:
  schemas:
