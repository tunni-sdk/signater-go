...
info:
  ...
  version: 1.0.0
paths:
  /v1/ecm/vaults/{vaultId}/unfavorite:
    post:
      summary: Unfavorite vault
      deprecated: false
      description: >-
        Removes the 'favorite' status from a specific vault for the currently
        authenticated user. This operation only affects the user's personal
        preferences and does not alter the vault's status for other users within
        the account.
      tags:
        - Vault
        - Vault
      ...
      responses:
        '204':
          description: Vault unfavorited successfully
          headers: {}
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/755605/apis/api-12252712-run
components:
  schemas:
