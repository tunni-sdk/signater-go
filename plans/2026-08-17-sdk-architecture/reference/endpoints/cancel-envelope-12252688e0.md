...
info:
  ...
  version: 1.0.0
paths:
  /v1/ecm/envelopes/{envelopeId}/cancel:
    post:
      summary: Cancel envelope
      deprecated: false
      description: >-
        Cancels an envelope using its unique identifier, terminating its
        approval process. Once canceled, the envelope cannot be resumed, and all
        signers will no longer be able to approve or reject the documents. This
        action is irreversible and will permanently stop any further
      ...
      responses:
        '204':
          description: Envelope canceled successfully
          headers: {}
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/755605/apis/api-12252688-run
components:
  schemas:
