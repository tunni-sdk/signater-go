...
info:
  ...
  version: 1.0.0
paths:
  /v1/ecm/contacts/{contactId}/unfavorite:
    post:
      summary: Unfavorite contact
      deprecated: false
      description: >-
        Removes the favorite status from a specific contact for the logged-in
        user using its unique identifier. This action is user-specific and does
        not impact the preferences of other users within the same account.
        Ensure the provided contact ID exists and is valid.
      tags:
        - Contact
        - Contact
      parameters:
      ...
      responses:
        '204':
          description: Contact unfavorited successfully
          headers: {}
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/755605/apis/api-12252673-run
components:
  schemas:
