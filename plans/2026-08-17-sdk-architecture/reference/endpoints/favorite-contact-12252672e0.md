...
info:
  ...
  version: 1.0.0
paths:
  /v1/ecm/contacts/{contactId}/favorite:
    post:
      summary: Favorite contact
      deprecated: false
      description: >-
        Marks a specific contact as a favorite for the logged-in user using its
        unique identifier. This action is user-specific and does not affect the
        preferences of other users within the same account. Ensure the provided
        contact ID exists and is valid.
      tags:
        - Contact
        - Contact
      parameters:
      ...
      responses:
        '204':
          description: Contact favorited successfully
          headers: {}
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/755605/apis/api-12252672-run
components:
  schemas:
