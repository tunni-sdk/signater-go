...
info:
  ...
  version: 1.0.0
paths:
  /v1/ecm/documents/{documentId}/signed:
    get:
      summary: Get document signed file URL
      deprecated: false
      description: Returns the URL to download the signed file of a document.
      tags:
        - Document
        - Document
      parameters:
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/GetDocumentSignedFileUrlApiResponse'
              example:
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/755605/apis/api-13038398-run
components:
  schemas:
    GetDocumentSignedFileUrlApiResponse:
      type: object
      properties:
        url:
          type: string
          description: The latest document signed file URL
          nullable: true
