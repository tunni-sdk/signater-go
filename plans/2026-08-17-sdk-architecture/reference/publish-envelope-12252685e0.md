...
info:
  ...
  version: 1.0.0
paths:
  /v1/ecm/envelopes/{envelopeId}/publish:
    post:
      summary: Publish envelope
      deprecated: false
      description: >-
        Publishes an existing envelope using its unique identifier, making it
        available for the signers. Once published, the signers associated with
        the envelope will receive access links for signing the documents. Ensure
        that the account has sufficient credits and that the envelope contains
        at least one signer and one document before performing this action.
      tags:
        - Envelope
        - Envelope
      parameters:
      ...
      responses:
        '204':
          description: Envelope published successfully
          headers: {}
      ...
      x-run-in-apidog: https://app.apidog.com/web/project/755605/apis/api-12252685-run
components:
  schemas:
